<nav role="navigation" class="navbar navbar-inverse">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a href="${pageContext.request.contextPath}/home" class="navbar-brand">Newtrino <span class="glyphicon glyphicon-leaf"></span></a>
        </div>

        <div id="bs-example-navbar-collapse-9" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#" class="developer-text">Developer - Anand Muley</a></li>
                <li><a href="logout" class="developer-text">Logout</a></li>
            </ul>
        </div>
      </div>
    </nav>